...
4. **Stamp the feedback section** — do not write it by hand:
   ...
   ```
5. **Register the skill** — README.md table, CLAUDE.md "Skills in the pack" line, CHANGELOG `[Unreleased]`. Verify with `node scripts/check-docs.cjs && node scripts/check-skill-name.cjs estack-<short-name>`.
