...
- **Skills in the pack:** `estack-active-learning-tutor`, `estack-better-title`, `estack-chris-voss`, `estack-claude-md-optimizer`, `estack-customer-discovery`, `estack-flight-planner`, `estack-github-issue-tracker`, `estack-leadership-coach`, `estack-productivity-prioritization-coach`, `estack-prompt-builder-coach`, `estack-read-claude-session-history`, `estack-repo-search`, `estack-vscode-file-recovery`
