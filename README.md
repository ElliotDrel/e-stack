...
| **Chris Voss** | `/estack-chris-voss` | Applies negotiation principles from *Never Split the Difference* when preparing for a negotiation or a hard conversation; the message itself goes to Email Writer or Cold Message Writer |
...
| **Cold Message Writer** | `/estack-cold-message-writer` | Writes first-touch messages to someone who does not know the sender — LinkedIn, email, or X DMs — that read as hand-typed for one person and actually get replies |
